...
public class CheckoutServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String address =  StringEscapeUtils.escapeHtml(request.getParameter("address")); // Store Xss Fix
        String phonenumber = StringEscapeUtils.escapeHtml(request.getParameter("phonenumber"));
