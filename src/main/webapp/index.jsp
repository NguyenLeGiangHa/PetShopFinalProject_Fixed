<%@ page import="bean.UserBean" %> <%@ page language="java"
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <%--<%@ page
import="bean.LoginBean" %>--%> <%--<%--%> <%--// LoginBean loginBean = new
LoginBean();--%> <%--// List<ProductEntity>
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
              <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<%=request.getContextPath()%>/shop"
                    >Shop</a
                  >
                </li>
                <li class="nav-item">
          ...
          <div class="banner-slide bg1">
            <div class="container">
              <div class="hero-content">
                ...
                <div class="cta-btn">
                  <a href="about.html" class="btn btn-style btn-primary"
                    >View More</a
                  >
                </div>
              </div>
        ...
        <div class="container py-md-5 py-4">
          <div class="row align-items-center">
            <div class="col-lg-6 pe-lg-5">
              ...
              <p class="text-para">
                Chăm sóc thú cưng của bạn là trách nhiệm của chúng tôi.
              </p>
              <a href="about.html" class="btn btn-style mt-sm-5 mt-4"
                >Discover More</a
              >
            </div>
            <div class="col-lg-6 mt-lg-0 mt-5">
              <div class="row">
                <div class="col-6 grids-1">
                  ...
                  <p>
                    Với các thiết bị hiện đại, thú cưng của bạn sẽ luôn mạnh
                    khỏe khi đến với chúng tôi
                  </p>
                </div>
                <div class="col-6 grids-1">
                ...
                <div class="col-6 grids-1 mt-5">
                  ...
                  <p>
                    Khi đến đây, bạn sẽ được cung cấp các kiến thức cho việc
                    nuôi thú cưng
                  </p>
                </div>
                <div class="col-6 grids-1 mt-5">
                  ...
                  <p>
                    Với đội ngũ dày dặn và nhiều kinh nghiệm, chúng tôi sẽ dạy
                    các kĩ năng cho thúc cưng của bạn
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="container py-lg-5">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 mb-lg-0 mb-5 order-lg-last order-first">
              ...
              <p class="mt-2 mb-sm-5 mb-4">
                Chúng tôi luôn ưu đãi cho các trường hợp đặc biệt.
              </p>
              <a
                href="tel:+(21) 255 999 8888"
                class="call-style d-flex align-items-center"
                ><i class="fas fa-phone-volume me-2"></i> +(21) 255 999 8888</a
              >
            </div>
          </div>
        </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
              <div class="area-box">
                ...
                <h4>
                  <a href="services.html" class="title-head"
                    >Chăm sóc thú cưng</a
                  >
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
              <div class="area-box">
                <i class="fas fa-paw"></i>
                <h4>
                  <a href="services.html" class="title-head">Huấn luyện</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
              <div class="area-box">
                ...
                <h4>
                  <a href="services.html" class="title-head"
                    >Thời gian nghỉ cho thú cưng</a
                  >
                </h4>
                <p>
                  Đừng bắt thú cưng phải luôn hoạt động mà hãy để chúng được
                  nghỉ ngơi, hồi phục thể trạng tốt nhất.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container py-md-5 py-4">
          <div class="row align-items-center">
            <div class="col-lg-6">
              ...
              <p>
                Nhiều hoạt động chăm sóc các thú cưng bị bỏ rơi và tìm nhà phù
                hợp cho chúng.
              </p>
            ...
            <div class="col-lg-4 col-md-6 grids5-info">
              ...
              <div class="blog-info-grid">
                ...
                <div class="blog-info mt-3">
                  <a href="#read"
                    >Read More <span class="fa fa-arrow-right ms-1"></span
                  ></a>
                  <a href="#comments"
                    ><span class="fa fa-comment-o"></span> 3 comments</a
                  >
                </div>
              </div>
            </div>
              ...
              >
                <div class="owl-stage-outer">
                  <div
                    class="owl-stage"
                    style="
                      transform: translate3d(-1530px, 0px, 0px);
                          ...
                          <div class="testimonial">
                            <blockquote>
                              <q
                                ...
                                adipisci dolor sit amet! by the Desire to
                                achieve Success.</q
                              >
                            </blockquote>
                            <div class="testi-des">
                      ...
                      <div class="item">
                        <div class="testimonial-content">
                          <div class="testimonial">
                            <blockquote>
                              <q
                                >Thú cưng của tôi như được mới mẻ khi đến shop
                                này.</q
                              >
                            </blockquote>
                            <div class="testi-des">
