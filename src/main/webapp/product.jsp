...
<!-- Bootstrap core JS-->
<script nonce="2526c7f26c" src= "./assets/css/bootstrap-icons.css"></script>
<!-- Core theme JS-->
<script nonce="2526c7f26c" src="js/scripts.js"></script>
<script nonce="2526c7f26c" src="assets/js/shopping-cart.js"></script>
<script nonce="2526c7f26c" src="assets/js/script.js"></script>
<%-- Script login--%>
