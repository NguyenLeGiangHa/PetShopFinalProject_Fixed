...
Date: 11/20/2022 Time: 3:04 PM To change this template use File | Settings |
...
<html>
  <html lang="en">
    ...
    <body>
        ...
        <div class="w3l-breadcrumb py-lg-5">
          <div class="container pt-4 pb-sm-4">
            ...
            <ul class="breadcrumbs-custom-path">
              ...
              <li class="active">
                <i class="fas fa-angle-right mx-2"></i>About
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="container py-md-5 py-4">
          <div class="row align-items-center">
            <div class="col-lg-6 pe-lg-5 mb-lg-0 mb-5">
              ...
              <p>
                Khi bạn cần những điều tốt đẹp cho thú cưng của bạn thì chúng
                tôi là một trong những người sẽ đáp ứng điều đó.
              </p>
              <div class="mt-4">
                <ul class="service-list">
                  <li class="service-link">
                    <a href="#url"
                      ><i class="fas fa-check-circle"></i>Dịch vụ hiện đại</a
                    >
                  </li>
                  <li class="service-link">
                    <a href="#url"
                      ><i class="fas fa-check-circle"></i>Sản phẩm đa dạng</a
                    >
                  </li>
                  <li class="service-link">
                    <a href="#url"
                      ><i class="fas fa-check-circle"></i>Chi phí phù hợp</a
                    >
                  </li>
                </ul>
              </div>
        ...
        <div class="container pb-md-5 pb-4">
          <div class="row">
            <div class="col-md-3 col-6 grids-1">
              ...
              <p>
                Với các thiết bị hiện đại, thú cưng của bạn sẽ luôn mạnh khỏe
            ...
            <div class="col-md-3 col-6 grids-1">
              ...
              <p>
                Nếu bạn không có thời gian để chăm sóc, hãy để chúng tôi làm
                điều đó
              </p>
            </div>
            <div class="col-md-3 col-6 grids-1 mt-md-0 mt-5">
              ...
              <p>
                Khi đến đây, bạn sẽ được cung cấp các kiến thức cho việc nuôi
                thú cưng
              </p>
            </div>
            <div class="col-md-3 col-6 grids-1 mt-md-0 mt-5">
              ...
              <p>
                Với đội ngũ dày dặn và nhiều kinh nghiệm, chúng tôi sẽ dạy các
                kĩ năng cho thúc cưng của bạn
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingOne">
                    ...
                    >
                      01. Tại sao thú cưng là một phần trong cuộc sống của chúng
                      ta?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Mỗi chúng ta đều có sở thích và thú vui cho riêng mình.
                      Việc nuôi thú cưng là một trong những điều đó.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingTwo">
                    ...
                    >
                      02. Chúng ta chăm sóc thú cưng của mình như thế nào?
                    </button>
                  </h2>
                  <div
                    id="collapseTwo"
                  ...
                  >
                    <div class="accordion-body">
                      Luôn yêu thương và chăm sóc bằng những điều tốt đẹp.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingThree">
                    ...
                    >
                      03. Bạn chọn thú cưng nào và tại sao?
                    </button>
                  </h2>
                  <div
                    id="collapseThree"
                  ...
                  >
                    <div class="accordion-body">
                      Hãy xem bản thân thích những thú cưng nào. Để ý những tác
                      nhân xung quanh và chọn phù hợp cho mình.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row text-center">
            <div class="col-md-3 col-6">
              <div class="team-grids text-center">
                <img
                  src="https://scontent.fsgn13-1.fna.fbcdn.net/v/t1.15752-9/315100267_703993097541515_3195386402725311669_n.jpg?_nc_cat=105&amp;ccb=1-7&amp;_nc_sid=ae9488&amp;_nc_ohc=JKlZDG7msmYAX-tC1WL&amp;tn=wX4SNKJLL1ax5dTx&amp;_nc_ht=scontent.fsgn13-1.fna&amp;oh=03_AdRKoQhAFRR82ZECY6HMyD3ZfgH_qEaZkQVEvQvswy1XEA&amp;oe=63988685"
                  class="img-fluid"
                  alt=""
                />
                <div class="team-info">
                  <div class="caption">
                    <div class="social-icons-section text-center">
                      <a
                        class="fac"
                        href="https://www.facebook.com/ngoc.cao.520900"
                      >
            ...
            <div class="col-md-3 col-6">
              <div class="team-grids text-center">
                <img
                  src="https://scontent.fsgn13-4.fna.fbcdn.net/v/t1.15752-9/306444382_515454500583603_2243839072551371980_n.jpg?_nc_cat=110&amp;ccb=1-7&amp;_nc_sid=ae9488&amp;_nc_ohc=HDrb4S8I3tYAX_H51g4&amp;_nc_ht=scontent.fsgn13-4.fna&amp;oh=03_AdRzBn0_WDN1uFNVyyJY37LEA7i0fy_LIxNQ7q9o_QThSQ&amp;oe=63986F96"
                  class="img-fluid"
                  alt=""
                />
                <div class="team-info">
                  <div class="caption">
                    <div class="social-icons-section text-center">
                      <a
                        class="fac"
                        href="https://www.facebook.com/trung.nguyen.258"
                      >
                        <i class="fab fa-facebook-f"></i>
                      </a>
                      <a class="twitter" href="#url">
        ...
        <div class="container pt-md-5 pt-4">
          <div class="row w3-testimonial-grids align-items-center">
            <div class="col-lg-6 w3-testimonial-content-top pr-lg-5">
              ...
              <div
                id="owl-demo1"
                class="owl-carousel owl-theme py-sm-2 mb-4 owl-loaded owl-drag"
              >
                <div class="owl-stage-outer">
                  <div
                    class="owl-stage"
                    style="
                      transform: translate3d(-2550px, 0px, 0px);
                      ...
                      <div class="item">
                        <div class="testimonial-content">
                          <div class="testimonial">
                            <blockquote>
                              <q
                                >Như cái ghế, vì shop không phải bàn. 10
                                điểm.</q
                              >
                            </blockquote>
                            <div class="testi-des">
                      ...
                      <div class="item">
                        <div class="testimonial-content">
                          <div class="testimonial">
                            <blockquote>
                              <q
                                >Shop nhiệt tình và các dịch vụ rất tốt cho thú
                                cưng.</q
                              >
                            </blockquote>
                            <div class="testi-des">
                      ...
                      <div class="item">
                        <div class="testimonial-content">
                          <div class="testimonial">
                            <blockquote>
                              <q
                                >Chi phí rất rẻ so với những gì mà thú cưng của
                                tôi được chăm sóc tại đây. 10 điểm 10 điểm ❤️
                              </q>
                            </blockquote>
                            <div class="testi-des">
                              <!--Timestamp Disclosure - Unix  -->
                        ...
                        <div class="testimonial-content">
                          <div class="testimonial">
                            ...
                            <div class="testi-des">
                              <div class="test-img">
                                <img
                                  src="https://cdn.britannica.com/28/215028-050-94E9EA1E/American-actor-Chris-Evans-2019.jpg"
                                  class="img-fluid"
                                  alt="client-img"
                                />
                              </div>
                      ...
                      <div class="item">
                        <div class="testimonial-content">
                          <div class="testimonial">
                            <blockquote>
                              <q
                                >Không còn gì để có thể nói về shop này. 10 điểm
                                ❤️
                              </q>
                            </blockquote>
                            <div class="testi-des">
                              ...
                              <div class="test-img">
                                <img
                                  src="assets/images/Manuel Neuer.jpg"
                                  class="img-fluid"
                                  alt="client-img"
                                />
                              </div>
            ...
            <div
              class="col-lg-6 position-relative ps-lg-5 mt-lg-0 mt-5 pt-lg-0 pt-sm-4"
            >
              <img
                ...
                <div class="row">
                  ...
                  <div class="col-6 column">
                    ...
                    <ul class="footer-contact-list">
                      ...
                      <li class="mt-2">
                        <a href="mailto:ex2002@gmail.com">ex2002@gmai.com</a>
                      </li>
                      <li class="mt-2">
                        <a href="mailto:info@example.com">hcmute@gmail.com</a>
                      </li>
                    </ul>
                  </div>
                  <iframe
      ...
      <script nonce="2526c7f26c" src="assets/js/owl.carousel.js"></script>
      <script nonce="2526c7f26c">
