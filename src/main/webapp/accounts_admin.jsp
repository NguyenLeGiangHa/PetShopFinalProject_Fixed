...
IntelliJ IDEA. User: ADMIN Date: 12/5/2022 Time: 9:53 PM To change this template
  ...
  <body id="reportsPage">
                ...
                <c:forEach items="${listAdmin}" var="admin">
                  <tr>
                    ...
                    <td class="text-center padlr-0">
                      <a
                        onclick="deleteadmin(${admin.getIdUser()})"
        ...
        <div class="row tm-content-row" style="justify-content: space-around">
          <div class="tm-block-col tm-col-account-settings">
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <form
                action="<%=request.getContextPath()%>/creatAdminAcount"
    ...
    <script nonce="2526c7f26c">
      function deleteadmin(id) {
        ...
        if (choice == true) {
          window.location =
            "<%=request.getContextPath()%>/deleteAdmin?idAdmin=" + id;
        } else {
        }
      }
    </script>
