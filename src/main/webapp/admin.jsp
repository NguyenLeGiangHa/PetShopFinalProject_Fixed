...
<head>
    ...
    <link  nonce="2526c7f26c" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,700">
    <!-- https://fonts.google.com/specimen/Roboto -->
    <link nonce="2526c7f26c" rel="stylesheet" href="admin/assets/css/fontawesome.min.css">
    <!-- https://fontawesome.com/ -->
    <link nonce="2526c7f26c" rel="stylesheet" href="admin/assets/css/bootstrap.min.css">
    <!-- https://getbootstrap.com/ -->
    <link nonce="2526c7f26c" rel="stylesheet" href="admin/assets/css/templatemo-style.css">
    <!--
...
<script nonce="2526c7f26c" src="admin/assets/js/jquery-3.3.1.min.js"></script>
<!-- https://jquery.com/download/ -->
<script nonce="2526c7f26c" src="admin/assets/js/moment.min.js"></script>
<!-- https://momentjs.com/ -->
<script nonce="2526c7f26c" src="admin/assets/js/Chart.min.js"></script>
<!-- http://www.chartjs.org/docs/latest/ -->
<script  nonce="2526c7f26c" src="admin/assets/js/bootstrap.min.js"></script>
<!-- https://getbootstrap.com/ -->
<script nonce="2526c7f26c" src="admin/assets/js/tooplate-scripts.js"></script>
