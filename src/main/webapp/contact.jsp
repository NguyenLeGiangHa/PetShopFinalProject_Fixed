...
Date: 11/20/2022 Time: 4:34 PM To change this template use File | Settings |
    ...
    <div class="w3l-contact-info pt-5" id="contact">
      <div class="container py-md-5 py-4">
        ...
        <div class="align-self pt-4">
          <div class="contact-infos">
            <div class="single-contact-infos">
              <div class="icon-box">
                <i class="fas fa-map-marker-alt color-1"></i>
              </div>
              <div class="text-box">
            ...
            <div class="single-contact-infos">
              <div class="icon-box">
                <i class="fas fa-envelope-open-text color-3"></i>
              </div>
              <div class="text-box">
        ...
        <div class="row mt-5 pt-md-5">
          ...
          <div
            class="col-lg-6 form-inner-cont order-lg-2 order-1 mb-lg-0 mb-5 ps-lg-4"
          >
            <form
